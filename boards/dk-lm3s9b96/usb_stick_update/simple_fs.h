...
//!
//! A non-zero value will be returned to the caller as long as successive
...
//! the sector buffer.
//!
//! \param ulSector is the absolute sector number to read from the storage
//! device
//! \param pucSectorBuf is a pointer to a 512 byte buffer where the sector
...
//
extern unsigned long SimpleFsReadMediaSector(unsigned long ulSector,
                                             unsigned char *pucSectorBuf);
...
//
//****************************************************************************
extern unsigned long SimpleFsInit(unsigned char *pucSectorBuf);
extern unsigned long SimpleFsOpen(char *pcName83);
extern unsigned long SimpleFsGetNextFileSector(unsigned long ulStartCluster);
