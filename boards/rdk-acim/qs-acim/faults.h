//*****************************************************************************
//
// faults.h - Definitions for the fault conditions that can occur in the A/C
...
//!
//! - Power module fault: This occurs when the smart power module detects a
//! fault condition.  The smart power module will signal a fault on a supply
//! under-voltage condition and an output over-current condition.
//!
...
//! thermocouple in order to measure.
//!
...
//*****************************************************************************
//
//! The fault flag that indicates that the power module asserted its fault
//! signal.
//
//*****************************************************************************
#define FAULT_POWER_MODULE      0x00000020
