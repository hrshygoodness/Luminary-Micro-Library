...
//! <h1>Access Point for use with eZ430-Chronos-868 (simpliciti_chronos)</h1>
//!
//! This application provides a SimpliciTI Low Power RF access point that is
//! capable of receiving and displaying data from an eZ430-Chronos-868
...
//! CC1101EM 868Mhz radio transceiver and antenna for this application to run
...
//!
//! The eZ430-Chronos-868 development tool uses the SimpliciTI protocol to
