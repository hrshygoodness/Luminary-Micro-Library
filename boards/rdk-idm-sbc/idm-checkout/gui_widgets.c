...
//                 interface for the idm_checkout application.
//
...
// match the indices labelled MOUSE_MODE_STR_x in gui_widgets.h.
//
//****************************************************************************
...
Canvas(g_sEKTitle, &g_sHomeScreen, &g_sStellarisWare, 0,
       ...
       CLR_BACKGROUND, 0, CLR_TEXT, g_pFontCmss22b, "IDM-SBC Reference Kit",
       0, 0);

RectangularButton(g_sIOExamplesBtn, &g_sHomeScreen, &g_sEKTitle, 0,
                  &g_sKitronix320x240x16_SSD2119, 20, 64, 180, 32,
                  ( PB_STYLE_TEXT | PB_STYLE_IMG | PB_STYLE_RELEASE_NOTIFY),
                   0, 0, 0, CLR_TEXT, g_pFontCmss18b, "IO Examples",
                   g_pucRedButton_180x32_Up, g_pucRedButton_180x32_Down,
                   0, 0, OnBtnShowIOScreen);

RectangularButton(g_sDemoBtn, &g_sHomeScreen, &g_sIOExamplesBtn, 0,
                  &g_sKitronix320x240x16_SSD2119, 20, 100, 180, 32,
                  ( PB_STYLE_TEXT | PB_STYLE_IMG | PB_STYLE_RELEASE_NOTIFY),
                   0, 0, 0, CLR_TEXT, g_pFontCmss18b, "Graphics Demo",
                   g_pucRedButton_180x32_Up, g_pucRedButton_180x32_Down,
                   0, 0, OnBtnShowDemoScreen);

RectangularButton(g_sAudioBtn, &g_sHomeScreen, &g_sDemoBtn, 0,
                  &g_sKitronix320x240x16_SSD2119, 20, 136, 180, 32,
                  ( PB_STYLE_TEXT | PB_STYLE_IMG | PB_STYLE_RELEASE_NOTIFY),
                   0, 0, 0, CLR_TEXT, g_pFontCmss18b, "Audio Player",
                   g_pucRedButton_180x32_Up, g_pucRedButton_180x32_Down,
                   0, 0, OnBtnShowAudioScreen);
RectangularButton(g_sImageBtn, &g_sHomeScreen, &g_sAudioBtn, 0,
                  &g_sKitronix320x240x16_SSD2119, 20, 172, 180, 32,
                  ( PB_STYLE_TEXT | PB_STYLE_IMG | PB_STYLE_RELEASE_NOTIFY),
                   0, 0, 0, CLR_TEXT, g_pFontCmss18b, "Image Viewer",
                   g_pucRedButton_180x32_Up, g_pucRedButton_180x32_Down,
                   0, 0, OnBtnShowImageScreen);
#define HOME_ROOT_BTN &g_sImageBtn
...
//
//*****************************************************************************
Container(g_sUSBContainer, &g_sIOScreen, 0, &g_sMouseBtn3,
...
//
//*****************************************************************************
Container(g_sBoardIOContainer, &g_sIOScreen, &g_sUSBContainer, &g_sSDCard2,
