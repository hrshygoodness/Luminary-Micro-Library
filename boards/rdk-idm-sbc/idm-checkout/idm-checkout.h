//*****************************************************************************
//
// idm_checkout.h - Prototypes and definitions shared between the files
//                  comprising the idm_checkout example application.
//
...
#ifndef __IDM_CHECKOUT_H__
#define __IDM_CHECKOUT_H__
