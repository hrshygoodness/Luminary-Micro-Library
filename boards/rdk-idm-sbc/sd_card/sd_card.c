...
TCPIPStackInit(void)
{
    ...
    LocatorAppTitleSet("RDK-IDM-SBC sd_card");
...
//*****************************************************************************
//
// This is the handler for this SysTick interrupt.  It is used to provide the
// timing reference for both the FAT file system and the TCP/IP stack.
//
//*****************************************************************************
void
...
main(void)
{
    ...
    while(1)
    {
        ...
        //
        // Is there a command waiting to be processed?  Keep waiting until we
        // find one or a remote firmware update request is received.
        //
        ...
        //
        // If a remote firmware update request was received, drop out.
        //
