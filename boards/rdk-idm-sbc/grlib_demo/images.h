...
extern const unsigned char g_pucRed50x50[];
extern const unsigned char g_pucRed50x50Press[];
...
extern const unsigned char g_pucFiveRedImage[];
extern const unsigned char g_pucSixRedImage[];
