...
void OnImgButtonPress(tWidget *pWidget);
...
Canvas(g_sMACAddr, g_psPanels, 0, 0,
       &g_sKitronix320x240x16_SSD2119, 0, 174, 160, 10,
       (CANVAS_STYLE_FILL | CANVAS_STYLE_TEXT),
       ClrBlack, 0, ClrSilver, g_pFontFixed6x8, g_pcMACString, 0, 0);
Canvas(g_sIPAddr, g_psPanels, &g_sMACAddr, 0,
       &g_sKitronix320x240x16_SSD2119, 160, 174, 160, 10,
       (CANVAS_STYLE_FILL | CANVAS_STYLE_TEXT),
       ClrBlack, 0, ClrSilver, g_pFontFixed6x8, g_pcIPString, 0, 0);
Canvas(g_sIntroduction, g_psPanels, &g_sIPAddr, 0,
       &g_sKitronix320x240x16_SSD2119, 0, 24, 320, 156,
...
//*****************************************************************************
//
// The ninth panel, which contains a selection of image buttons.
//
//*****************************************************************************
tCanvasWidget g_psImageButtonIndicators[] =
{
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 1, 0,
                 &g_sKitronix320x240x16_SSD2119, 40, 85, 20, 20,
                 CANVAS_STYLE_IMG, 0, 0, 0, 0, 0, g_pucLightOff, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 2, 0,
                 &g_sKitronix320x240x16_SSD2119, 90, 85, 20, 20,
                 CANVAS_STYLE_IMG, 0, 0, 0, 0, 0, g_pucLightOff, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 3, 0,
                 &g_sKitronix320x240x16_SSD2119, 145, 85, 20, 20,
                 CANVAS_STYLE_IMG, 0, 0, 0, 0, 0, g_pucLightOff, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 4, 0,
                 &g_sKitronix320x240x16_SSD2119, 40, 165, 20, 20,
                 CANVAS_STYLE_IMG, 0, 0, 0, 0, 0, g_pucLightOff, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 5, 0,
                 &g_sKitronix320x240x16_SSD2119, 90, 165, 20, 20,
                 CANVAS_STYLE_IMG, 0, 0, 0, 0, 0, g_pucLightOff, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 6, 0,
                 &g_sKitronix320x240x16_SSD2119, 145, 165, 20, 20,
                 CANVAS_STYLE_IMG, 0, 0, 0, 0, 0, g_pucLightOff, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 7, 0,
                 &g_sKitronix320x240x16_SSD2119, 190, 35, 110, 24,
                 CANVAS_STYLE_TEXT, 0, 0, ClrSilver, g_pFontCm20, "Non-auto",
                 0, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 8, 0,
                 &g_sKitronix320x240x16_SSD2119, 190, 55, 110, 24,
                 CANVAS_STYLE_TEXT, 0, 0, ClrSilver, g_pFontCm20, "repeat",
                 0, 0),
    CanvasStruct(g_psPanels + 8, g_psImageButtonIndicators + 9, 0,
                 &g_sKitronix320x240x16_SSD2119, 190, 115, 110, 24,
                 CANVAS_STYLE_TEXT, 0, 0, ClrSilver, g_pFontCm20, "Auto",
                 0, 0),
...
{
    ImageButtonStruct(g_psPanels + 8, g_psImageButtons + 1, 0,
                      &g_sKitronix320x240x16_SSD2119, 30, 35, 40, 40,
                      (IB_STYLE_FILL | IB_STYLE_TEXT | IB_STYLE_IMAGE_OFF |
                      IB_STYLE_KEYCAP_OFF),
                      ClrSilver, ClrRed, ClrMidnightBlue,
                      g_pFontCm22, "1", 0, 0, 0, 0, 0,
                      0, 0, OnImgButtonPress),
    ImageButtonStruct(g_psPanels + 8, g_psImageButtons + 2, 0,
                      &g_sKitronix320x240x16_SSD2119, 75, 30, 50, 50,
                      (IB_STYLE_TEXT | IB_STYLE_KEYCAP_OFF),
                      ClrSilver, 0, 0, g_pFontCm22, "3", g_pucRed50x50,
                      g_pucRed50x50Press, 0, 3, 3,
                      0, 0, OnImgButtonPress),
    ImageButtonStruct(g_psPanels + 8, g_psImageButtons + 3, 0,
                      &g_sKitronix320x240x16_SSD2119, 130, 30, 50, 50,
                      0, ClrSilver, 0, 0,
                      g_pFontCm22, 0, g_pucBlue50x50,
                      g_pucBlue50x50Press, g_pucFiveRedImage, 3, 3,
                      0, 0, OnImgButtonPress),
    ImageButtonStruct(g_psPanels + 8, g_psImageButtons + 4, 0,
                      &g_sKitronix320x240x16_SSD2119, 30, 115, 40, 40,
                      (IB_STYLE_FILL | IB_STYLE_TEXT | IB_STYLE_IMAGE_OFF |
                      IB_STYLE_KEYCAP_OFF | IB_STYLE_AUTO_REPEAT),
                      ClrSilver, ClrRed, ClrMidnightBlue,
                      g_pFontCm22, "2", 0, 0, 0, 0, 0,
                      125, 25, OnImgButtonPress),
    ImageButtonStruct(g_psPanels + 8, g_psImageButtons + 5, 0,
                      &g_sKitronix320x240x16_SSD2119, 75, 110, 50, 50,
                      (IB_STYLE_TEXT | IB_STYLE_KEYCAP_OFF |
                      IB_STYLE_AUTO_REPEAT),
                      ClrSilver, 0, 0, g_pFontCm22, "4", g_pucRed50x50,
                      g_pucRed50x50Press, 0, 3, 3,
                      125, 25, OnImgButtonPress),
    ImageButtonStruct(g_psPanels + 8, g_psImageButtonIndicators, 0,
                      &g_sKitronix320x240x16_SSD2119, 130, 110, 50, 50,
                      IB_STYLE_AUTO_REPEAT, ClrSilver, 0, 0,
                      g_pFontCm22, 0, g_pucBlue50x50,
                      g_pucBlue50x50Press, g_pucSixRedImage, 3, 3,
                      125, 25, OnImgButtonPress),
};

#define NUM_IMAGE_BUTTONS       (sizeof(g_psImageButtons) /   \
                                 sizeof(g_psImageButtons[0]))
unsigned long g_ulImgButtonState;
...
tCanvasWidget g_psPanels[] =
{
    ...
    CanvasStruct(0, 0, g_psSliders, &g_sKitronix320x240x16_SSD2119, 0,
                 24, 320, 166, CANVAS_STYLE_FILL, ClrBlack, 0, 0, 0, 0, 0, 0),
    CanvasStruct(0, 0, g_psImageButtons, &g_sKitronix320x240x16_SSD2119, 0,
                 24, 320, 166, CANVAS_STYLE_FILL, ClrBlack, 0, 0, 0, 0, 0, 0),
};
...
TCPIPStackInit(void)
{
    ...
    LocatorAppTitleSet("RDK-IDM-SBC grlib_demo");
...
unsigned long IPAddressChangeCheck(unsigned long ulCurrentIP)
{
    ...
    {
        //
        // Yes - update the string that is shown on the display.
        //
        ...
        //
        // If we are currently showing the first panel, go ahead and repaint
        // the address string now.
        //
        if(g_ulPanel == 0)
        {
...
OnIntroPaint(tWidget *pWidget, tContext *pContext)
{
    ...
    //
    GrContextFontSet(pContext, g_pFontCmss18);
    GrContextForegroundSet(pContext, ClrSilver);
    GrStringDraw(pContext,
                 "This application demonstrates the Stellaris Graphics",
                 -1, 0, 32, 0);
    GrStringDraw(pContext, "Library.", -1, 0, 50, 0);
    GrStringDraw(pContext,
                 "Each panel shows a different feature of the",
                 -1, 0, 76, 0);
    GrStringDraw(pContext,
                 "graphics library. Widgets on the panels are fully",
                 -1, 0, 94, 0);
    GrStringDraw(pContext,
                 "operational; pressing them will result in visible",
                 -1, 0, 112, 0);
    GrStringDraw(pContext,
                 "feedback of some kind. Press the + and -",
                 -1, 0, 130, 0);
    GrStringDraw(pContext,
                 "buttons to move between the panels",
                 -1, 0, 148, 0);
}
...
//*****************************************************************************
//
// Handles press notifications for the image button widgets.
//
//*****************************************************************************
void
OnImgButtonPress(tWidget *pWidget)
{
    unsigned long ulIdx;

    //
    // Find the index of this image button.
    //
    for(ulIdx = 0; ulIdx < NUM_IMAGE_BUTTONS; ulIdx++)
    {
        if(pWidget == (tWidget *)(g_psImageButtons + ulIdx))
        {
            break;
        }
    }
    ...
    // Toggle the state of this push button indicator.
    //
    g_ulImgButtonState ^= 1 << ulIdx;

    //
    // Set the matching indicator based on the selected state of the check box.
    //
    CanvasImageSet(g_psImageButtonIndicators + ulIdx,
                   (g_ulImgButtonState & (1 << ulIdx)) ? g_pucLightOn :
                   g_pucLightOff);
    WidgetPaint((tWidget *)(g_psImageButtonIndicators + ulIdx));
...
main(void)
{
    ...
    //
    // Turn on the display backlight at maximum brightness.
    //
