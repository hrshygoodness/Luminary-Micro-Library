...
//
// Default the Join context to off so that the access point can change the
// Link token without running the risk of someone joining before this is done.
//
#define STARTUP_JOINCONTEXT_OFF
