//*****************************************************************************
//
// kitronix320x240x16_ssd2119.c - Display driver for the Kitronix K350QVG-V1-F
...
#define LCD_DATAH_PERIPH        SYSCTL_PERIPH_GPIOF
#define LCD_DATAH_BASE          GPIO_PORTF_BASE
#define LCD_DATAL_PERIPH        SYSCTL_PERIPH_GPIOB
#define LCD_DATAL_BASE          GPIO_PORTB_BASE
#define LCD_DC_RD_WR_PERIPH     SYSCTL_PERIPH_GPIOH
...
#define LCD_BL_TIMER_PERIPH     SYSCTL_PERIPH_TIMER3
#define LCD_BL_TIMER            TIMER_A
#define LCD_BL_TIMER_BASE       TIMER3_BASE
...
WriteCommand(unsigned char ucData)
{
    ...
    // OK according to the SSD2119 datasheet. Do this twice to ensure that the
    //
...
Kitronix320x240x16_SSD2119Init(void)
{
    ...
    SysCtlPeripheralEnable(LCD_DC_RD_WR_PERIPH);
    ...
    GPIOPadConfigSet(LCD_DATAL_BASE, 0xff, GPIO_STRENGTH_8MA,
                     GPIO_PIN_TYPE_STD);
    ...
    //
    GPIODirModeSet(LCD_DATAH_BASE, 0xff, GPIO_DIR_MODE_OUT);
    GPIOPadConfigSet(LCD_DATAH_BASE, 0xff, GPIO_STRENGTH_8MA,
                     GPIO_PIN_TYPE_STD);
    GPIODirModeSet(LCD_BL_BASE, LCD_BL_PIN, GPIO_DIR_MODE_OUT);
    GPIOPadConfigSet(LCD_BL_BASE, LCD_BL_PIN, GPIO_STRENGTH_8MA,
                     GPIO_PIN_TYPE_STD);
    GPIODirModeSet(LCD_DC_BASE, (LCD_DC_PIN | LCD_RD_PIN | LCD_WR_PIN),
                   GPIO_DIR_MODE_OUT);
    GPIOPadConfigSet(LCD_DC_BASE, (LCD_DC_PIN | LCD_RD_PIN | LCD_WR_PIN),
    ...
    GPIOPinWrite(LCD_DC_BASE, (LCD_DC_PIN | LCD_RD_PIN | LCD_WR_PIN),
