//*****************************************************************************
//
// simpliciti_range_extender.c - SimpliciTI LPRF Range Extender example.
//
...
//! <h1>Range Extender for ``Polling with Access Point'' example
//! (simpliciti_range_extender)</h1>
//!
...
Canvas(g_sHeading, WIDGET_ROOT, &g_sMainStatus, &g_sBackground,
       ...
       ClrDarkBlue, ClrWhite, ClrWhite, g_pFontCm20,
       "SimpliciTI-range-extender", 0, 0);
