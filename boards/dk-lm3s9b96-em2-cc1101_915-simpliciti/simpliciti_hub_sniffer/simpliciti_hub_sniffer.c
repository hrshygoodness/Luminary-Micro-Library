//*****************************************************************************
//
// simpliciti_hub_sniffer.c - SimpliciTI LPRF Channel Sniffer example.
//
...
//! <h1>Channel Sniffer for use with ``Access Point as a Data Hub'' example
//! (simpliciti_hub_sniffer)</h1>
//!
