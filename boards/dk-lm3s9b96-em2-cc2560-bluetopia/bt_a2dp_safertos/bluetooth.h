...
//               module for Stellaris Bluetooth A2DP Demo.
//
...
//*****************************************************************************
//
// The following defines the default name that will be discoverable by other
// Bluetooth devices.
//
//*****************************************************************************
#define DEFAULT_DEVICE_NAME "A2DP Demo"
...
typedef enum
{
    ...
    ceAudioEndpointOpen,
    ceAudioEndpointClose,
    ceAudioStreamStart,
    ceAudioStreamSuspend,
    ceRemoteControlConnectionOpen,
    ceRemoteControlConnectionClose
} tCallbackEvent;

//*****************************************************************************
//
// The following enumerated type is used with SendRemoteControlCommand()
// function to specify the command to send.
//
//*****************************************************************************
typedef enum
{
...
extern int PinCodeResponse(unsigned char *pucBDAddr, int iPinCodeLength,
                           char *pcPinCode);
extern int SendRemoteControlCommand(tRemoteControlCommand sCommand);
