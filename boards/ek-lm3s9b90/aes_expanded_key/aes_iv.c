...
//
//*****************************************************************************
static unsigned long g_ulWalkCounter;
...
//
//*****************************************************************************
const unsigned char g_pucApplicationUnique[8] =
{
...
//!
//! \param pucIV is where the generated initialization vector is stored.
...
//*****************************************************************************
void
AESGenerateIV(unsigned char pucIV[16], int bNewTime)
{
    //
    ...
    //
    ((unsigned long *)pucIV)[0] = g_ulWalkCounter;
    ((unsigned long *)pucIV)[1] = g_ulTime;
    ((unsigned long *)pucIV)[2] = ((unsigned*)g_pucApplicationUnique)[0];
    ((unsigned long *)pucIV)[3] = ((unsigned*)g_pucApplicationUnique)[1];
}
