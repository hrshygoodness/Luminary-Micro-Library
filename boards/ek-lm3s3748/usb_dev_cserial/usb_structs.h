//****************************************************************************
//
// usb_structs.h - Data structures defining this USB CDC device.
//
...
extern unsigned long RxHandlerEcho(void *pvCBData, unsigned long ulEvent,
                                   unsigned long ulMsgValue, void *pvMsgData);
extern unsigned long TxHandlerEcho(void *pvlCBData, unsigned long ulEvent,
                                   unsigned long ulMsgValue, void *pvMsgData);
extern unsigned long RxHandlerCmd(void *pvCBData, unsigned long ulEvent,
                                  unsigned long ulMsgValue, void *pvMsgData);
extern unsigned long TxHandlerCmd(void *pvlCBData, unsigned long ulEvent,
                                  unsigned long ulMsgValue, void *pvMsgData);

extern const tUSBBuffer g_psTxBuffer[2];
extern const tUSBBuffer g_psRxBuffer[2];
extern const tUSBDCDCDevice g_psCDCDevice[2];
