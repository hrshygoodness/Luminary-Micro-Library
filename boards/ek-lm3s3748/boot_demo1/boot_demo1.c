...
//! startup, the application will configure the UART and branch to the boot
//! loader to await the start of an update.  The UART will always be configured
//! at 115,200 baud and does not require the use of auto-bauding.
//!
