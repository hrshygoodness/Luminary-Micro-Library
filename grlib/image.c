...
{
    long lStart, lLen, lIndex, lStartX0, lOn, lOff, lNumBytes, lBit;
    ...
    switch(lBPP)
    {
        ...
        case 1:
        {
            ...
            // pixels transparent.
            //
            ulMask = ulTransparent ? 0xFFFFFFFF : 0;

            //
            // Loop through the bytes in the pixel data.
            //
            for(lIndex = 0, lX0 = 0, lBit = lX0; lIndex < lNumBytes; )
            {
                //
                ...
                for(lOff = 0; lIndex < lNumBytes; )
                {
                    ...
                    //
                    lCount = NumLeadingZeros((pucData[lIndex] << (24 + lBit)) ^
                                             ulMask);
                ...
                for(lOn = 0; lIndex < lNumBytes; )
                {
                    ...
                    //
                    lCount = NumLeadingZeros(~((pucData[lIndex] <<
                                             (24 + lBit)) ^ ulMask));
                ...
                if(lOn)
                {
                    DpyLineDrawH(pContext->pDisplay, lX + lOff, lX + lOff + lOn,
                                 lY, pContext->ulForeground);
                }
        ...
        case 4:
        {
            ...
            //
            for(lIndex = lX0; lIndex < (lCount / 2);)
            {
                //
                ...
                // Read the next pixel.
                //
                ucPixel = (pucData[lIndex] >> (lX0 ? 0 : 4)) & 0x0F;
                       ...
                       long lX, long lY, unsigned long ulTransparent)
{
    ...
    if(!(lBPP & 0x80))
    {
        ...
        while(lHeight--)
        {
            ...
            // Draw this row of image pixels.
            //
            PixelTransparentDraw(pContext, lX + lX0, lY, lX0 & 7,
                                 lX2 - lX0 + 1, lBPP,
                                 pucImage + ((lX0 * lBPP) / 8), pucPalette,
                                 ulTransparent);
