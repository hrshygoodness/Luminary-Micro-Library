...
#define __bsp_BUTTON1_PORT__            HWREG(GPIO_PORTJ_BASE + (GPIO_O_DATA + BV(__bsp_BUTTON1_BIT__ + 2)))
...
#define __bsp_BUTTON_EXTENDED_CONFIG__() st(                                 \
        MAP_GPIODirModeSet(GPIO_PORTJ_BASE, GPIO_PIN_7, GPIO_DIR_MODE_IN);   \
        MAP_GPIOPadConfigSet(GPIO_PORTJ_BASE, GPIO_PIN_7, GPIO_STRENGTH_2MA, \
