...
static volatile uint8_t sMgmtTid = 0;
...
fhStatus_t nwk_processMgmt(mrfiPacket_t *frame)
{
   ...
   */
  if (SMPL_MY_REPLY == (replyType=nwk_isValidReply(frame, sMgmtTid, MB_APP_INFO_OS, MB_TID_OS)))
  {
