...
#define HCI_NUMBER_OF_COMPLETED_DATA_BLOCKS_EVENT_SIZE(_x)  ((sizeof(HCI_Number_Of_Completed_Data_Blocks_Event_t) - sizeof(Byte_t)) + ((_x)*(sizeof(Word_t)+sizeof(Word_t)+sizeof(Word_t))))
...
#define HCI_NUMBER_OF_COMPLETED_DATA_BLOCKS_EVENT_READ_NUM_PACKETS(_x, _y) \
   READ_UNALIGNED_WORD_LITTLE_ENDIAN((((Byte_t *)((_x)->Variable_Data)) + ((_y)*(sizeof(Word_t) + sizeof(Word_t) + sizeof(Word_t))) + sizeof(Word_t)))
...
#define HCI_NUMBER_OF_COMPLETED_DATA_BLOCKS_EVENT_READ_NUM_BLOCKS(_x, _y) \
   READ_UNALIGNED_WORD_LITTLE_ENDIAN((((Byte_t *)((_x)->Variable_Data)) + ((_y)*(sizeof(Word_t) + sizeof(Word_t) + sizeof(Word_t))) + (sizeof(Word_t) + sizeof(Word_t))))
...
#define HCI_LE_ADVERTISING_FLAGS_LIMITED_DISCOVERABE_MODE_FLAGS_BIT_MASK                   0x01
#define HCI_LE_ADVERTISING_FLAGS_GENERAL_DISCOVERABE_MODE_FLAGS_BIT_MASK                   0x02
