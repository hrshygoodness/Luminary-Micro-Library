...
#define READ_UNALIGNED_BYTE_LITTLE_ENDIAN(_x)  (((Byte_t *)(_x))[0])
   ...
   /* (in the Endian-ness of the Native Host Processor).                */
#define READ_UNALIGNED_WORD_LITTLE_ENDIAN(_x)   (((Word_t *)(_x))[0])
...
#define READ_UNALIGNED_DWORD_LITTLE_ENDIAN(_x)  (((DWord_t *)(_x))[0])
...
#define READ_UNALIGNED_QWORD_LITTLE_ENDIAN(_x)  (((QWord_t *)(_x))[0])
