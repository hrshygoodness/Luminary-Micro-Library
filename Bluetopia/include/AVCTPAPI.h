/*****< avctpapi.h >***********************************************************/
/*      Copyright 2005 - 2011 Stonestreet One.                                */
/*      All Rights Reserved.                                                  */
/*                                                                            */
...
#define SDP_ASSIGN_AUDIO_VIDEO_CONTROL_TRANSPORT_PROTOCOL_UUID_16(_x)   ASSIGN_UUID_16((_x), 0x00, 0x17)
   ...
   /* AUDIO_VIDEO_CONTROL_TRANSPORT_PROTOCOL_UUID_16 Constant value.    */
#define SDP_ASSIGN_AUDIO_VIDEO_CONTROL_TRANSPORT_PROTOCOL_UUID_32(_x)   ASSIGN_UUID_32((_x), 0x00, 0x00, 0x00, 0x17)
...
#define SDP_ASSIGN_AUDIO_VIDEO_CONTROL_TRANSPORT_PROTOCOL_UUID_128(_x)  ASSIGN_UUID_128((_x), 0x00, 0x00, 0x00, 0x17, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB)
...
#define AVCTP_SDP_SERVICE_RECORD_SIZE                                    (sizeof(AVCTP_SDP_Service_Record_t))
   ...
   /* Types that are supported by the Audio/Video Control Transport     */
   /* Protocol.  These types are specified when a Audio/Video Control   */
   /* Transport Server is created.                                      */
typedef enum
{
   stRemoteControlTarget,
   stRemoteControl
} AVCTP_Service_Type_t;
