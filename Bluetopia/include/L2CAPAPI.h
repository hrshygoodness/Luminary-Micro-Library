...
#define L2CA_ECHO_CONFIRMATION_SIZE(_x)                 (sizeof(L2CA_Echo_Confirmation_t) - sizeof(Byte_t) + (unsigned int)(_x))
...
typedef struct _tagL2CA_Information_Confirmation_t
{
   ...
   /* Request.                                                          */
#define L2CA_INFORMATION_CONFIRMATION_SIZE(_x)          (sizeof(L2CA_Information_Confirmation_t) - sizeof(Byte_t) + (unsigned int)(_x))
...
#define L2CA_GROUP_DATA_INDICATION_SIZE(_x)           (sizeof(L2CA_Group_Data_Indication_t) - sizeof(Byte_t) + (unsigned int)(_x))
...
#define L2CA_DATA_INDICATION_SIZE(_x)                   (sizeof(L2CA_Data_Indication_t) - sizeof(Byte_t) + (unsigned int)(_x))
