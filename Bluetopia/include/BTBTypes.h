...
#define EXTENDED_INQUIRY_RESPONSE_DATA_SIZE     (sizeof(Extended_Inquiry_Response_Data_t))
   ...
   /* length of the of the data element, which includes the type and    */
   /* data.  See the Bluetooth Specification 2.1 + EDR, Volume 3, Part  */
   /* C, Section 8 for more information.                                */
